...
public class SerialConsoleActivity extends Activity implements TextureView.SurfaceTextureListener {
    ...
    public void onSurfaceTextureUpdated(SurfaceTexture surface) {
        ...
        if (c != null) {
            ...
            String toSend = "" + COM;
            canvas.drawText("COM = " + toSend, 10, 200, paint1);

            //byte[] sData = {COM,0}; try { sPort.write(sData, 10); } catch (IOException e) { }

            byte[] sData = toSend.getBytes(); try { sPort.write(sData, 10); } catch (IOException e) { }
